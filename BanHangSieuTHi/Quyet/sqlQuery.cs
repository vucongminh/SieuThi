...
namespace BanHangSieuTHi.Quyet
{
    class sqlQuery
    {
        ...
        public static string ConnectionString = @"Data Source=DESKTOP-J9T3NL5; ;Initial Catalog =QLBanHangSieuThi; User =sa; Password=12345";//;Integrated Security = false
        public sqlQuery()
        {
            try
            {
